...
3. Clean up the messy formatting in the values. Standardize ALL dates and timestamps to ISO 8601 format (YYYY-MM-DD or YYYY-MM-DDTHH:MM:SS).
...
5. Standardize ALL dates and timestamps to ISO 8601 format (YYYY-MM-DD or YYYY-MM-DDTHH:MM:SS) where applicable.
